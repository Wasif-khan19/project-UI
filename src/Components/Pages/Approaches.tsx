...
const Approach = () => {
  return (
    <section className="w-full py-20">
      <h1 className="heading text-center font-bold text-6xl">
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-slate-800 max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl"
      style={{
        background: "black",
  ...
  return (
    <div>
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px]">
        ...
        />
        <span
          className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-black px-5 py-2 text-white backdrop-blur-3xl font-bold text-2xl"
        >
          {order}
        </span>
      </button>
